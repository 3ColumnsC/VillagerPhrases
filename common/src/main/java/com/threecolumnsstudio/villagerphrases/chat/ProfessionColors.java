...
public final class ProfessionColors {
    ...
    private static final Map<String, Integer> COLORS = Map.ofEntries(
        Map.entry("farmer",        0xFF8B5A2B),
        Map.entry("fisherman",     0xFF2E6F95),
        Map.entry("shepherd",      0xFF6B4423),
        Map.entry("fletcher",      0xFF8B7355),
        Map.entry("librarian",     0xFFEDE4D3),
        Map.entry("cartographer",  0xFFB8D8E8),
        Map.entry("cleric",        0xFF7B4FA1),
        Map.entry("armorer",       0xFF4A4A4A),
        Map.entry("weaponsmith",   0xFF5C4033),
        Map.entry("toolsmith",     0xFF7A6B5A),
        Map.entry("butcher",       0xFFA8312A),
        Map.entry("leatherworker", 0xFF8B4513),
        Map.entry("mason",         0xFFA89B8C)
    );
